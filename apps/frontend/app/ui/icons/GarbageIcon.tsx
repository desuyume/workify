...
export default function GarbageIcon({ isColored = false, className, onClick }: GarbageIconProps) {
  return (
    <button
      onClick={onClick}
      className={cn(
    ...
    >
      ...
      >
        <path
          ...
          stroke='#FEFDF3'
        />
        <path d='M9.22229 13.2227L17.7778 21.7782' stroke='#FEFDF3' strokeLinecap='round' />
        <path d='M17.7778 13.2227L9.22228 21.7782' stroke='#FEFDF3' strokeLinecap='round' />
      </svg>
    </button>
  )
}
