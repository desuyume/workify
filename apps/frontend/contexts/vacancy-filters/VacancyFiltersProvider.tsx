...
export const VacancyFiltersProvider: React.FC<VacancyFiltersProviderProps> = ({ children }) => {
  ...
  return <VacancyFiltersContext.Provider value={value}>{children}</VacancyFiltersContext.Provider>
}
