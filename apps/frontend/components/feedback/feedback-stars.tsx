...
export default function FeedbackStars({ starsCount, reviewsCount }: FeedbackStarsProps) {
  return (
    <div className='w-full flex items-center mb-[0.3125rem] last-of-type:mb-0'>
      ...
      <p className='font-light text-lg leading-[1.375rem]'>{reviewsCount} отзывов</p>
    </div>
  )
}
