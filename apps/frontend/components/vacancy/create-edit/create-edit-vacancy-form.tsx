...
export default function CreateEditVacancyForm({ className }: CreateEditVacancyFormProps) {
  ...
  return (
    ...
    >
      <div className='w-full h-10 flex items-center'>
        <p className='min-w-[6.875rem] mr-[2.8125rem] font-medium text-xl'>Название</p>
        <Input
          value={vacancy.title}
          onChange={(e) =>
            setVacancy({
      ...
      <div className='w-full h-10 flex items-center'>
        <p className='min-w-[6.875rem] mr-[2.8125rem] font-medium text-xl'>Категория</p>
      ...
      <div className='w-full h-10 flex items-center'>
        <p className='min-w-[6.875rem] mr-[2.8125rem] font-medium text-xl'>Цена</p>
        <Input
          value={vacancy.price ?? ''}
          onChange={(e) =>
            setVacancy({
        ...
        <div className='flex-1 flex flex-col'>
          ...
          <SettingSwitch
            ...
            onChange={(e) =>
              setVacancy({
                ...vacancy,
                isLocationHidden: e.target.checked
              })
            }
            className='px-5'
