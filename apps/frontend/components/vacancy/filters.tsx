...
export default function Filters() {
	return (
		<VacancyFiltersProvider>
			<div className='w-[19.375rem] h-[39.8125rem] foreground rounded-[0.3125rem] border-t border-white flex flex-col'>
				<div className='w-full h-[30.4375rem] pt-[0.9375rem] pb-[2.1875rem] px-[1.9375rem] flex flex-col justify-between'>
					<Categories />
					<Cost />
					{/* <WorkAmount /> */}
					<Cities />
